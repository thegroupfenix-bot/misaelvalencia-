...
function DocPDF({ doc, agentProfile, boundMedia, lang = "es" }) {
  ...
  // PDF text key — routes certifications/timeline/mandatory blocks by category.
  // Uses CommercialEngine category first; falls back to legacy string-match for old docs.
  ...
  } else if (pdfTextKey === "fruit") {
    productDesc = docLang === "en"
      ? `Fresh or processed fruit product sourced from certified facilities. Meets international phytosanitary and quality standards for export.`
      : `Producto de fruta fresca o procesada de establecimientos certificados. Cumple con normas fitosanitarias y de calidad internacional para exportación.`;
  } else {
    productDesc = docLang === "en"
  ...
  if (pdfTextKey === "livestock") {
    ...
    certifications = docLang === "en"
      ? "• Official phytosanitary certificate from the exporting country\n• Certificate of origin\n• Cold-chain documentation and temperature logs\n• Pesticide residue analysis within MRL limits\n• Packing list and quality inspection certificate"
      : "• Certificado fitosanitario oficial del país exportador\n• Certificado de origen\n• Documentación de cadena de frío y registros de temperatura\n• Análisis de residuos de plaguicidas dentro de los LMR\n• Lista de empaque y certificado de inspección de calidad";
  }
