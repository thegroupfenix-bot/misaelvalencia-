      ...
      <Page size="A4" style={s.coverPage}>
        <View style={[s.coverBg, { backgroundColor: coverBg }]}>
          <View>
            ...
            <Text style={s.coverSub}>Destino / Destination: {doc.destination}{(doc.commercialData?.destinationPort || doc.commercial_data?.destinationPort || portInfo?.port) ? ` — ${doc.commercialData?.destinationPort || doc.commercial_data?.destinationPort || portInfo?.port}` : ""}</Text>
